...
server2 <- function(input, output) {
    runjs("document.getElementById('myaudio').volume = 0.2;") # initially reduce volume
        runjs(sprintf("document.getElementById('myaudio').src = '%s';", "https://p.scdn.co/mp3-preview/298e4ba91ea45111be4f84e8de2b70d07b7f1247?cid=e1672700ae5648848338d2352cdc375e"))
}

server3 <- function(input, output) {
    runjs("document.getElementById('myaudio').volume = 0.2;") # initially reduce volume
        runjs(sprintf("document.getElementById('myaudio').src = '%s';", "https://p.scdn.co/mp3-preview/b8c621280225ef15dc49e9056e5357bb84df3811?cid=e1672700ae5648848338d2352cdc375e"))        
}
