...
These are some questions that were included in our survey, which we asked participants in order to get a better insight into the perceived emotion in music performed in a foreign language compared to those in a native language.
...
* Although most tracks are rated similar to their assigned valence values, no major differences between the levels of valence were observed

* Hindi music were consistently rated high in perceived valence regardless of its assigned numerical rating on Spotify

* People cannot differentiate between sad and neutral songs, they seem to only be aware of above average levels of happiness in songs regardless of whether they were performed in their native languages or not

### Native versus non-native
The last four plots on the right show the perceived valences of native speakers compared to those of non-native speakers. It can be seen that:

* In general, there is no clear distinction in perceived emotion between natives and non-natives

* English and Mandarin songs were rated higher in valence by non-native speakers than native speakers

* Mandarin songs were rated higher in valence by non-native speakers than native speakers
...
##### Age-gender distribution
The histogram shows the distribution of the participants in terms of age and gender. Most participants were female followed by males then Non-binary and, lastly, there was one person categorised as 'other'. Since most participants are aged 18-25 the most seen highest education degree is highschool.

Enjoyment {data-navmenu=Results}
====================================================

Column {data-width=350}
---------------------------------------------------
### Comparing familiarity to enjoyment
...
ggplot(lik_fam, aes(x=familiar, y=enjoyable, size = valence, color = language)) +
  ...
  scale_fill_manual(values=c("#4BC5BA", "#7D4BC5", "#C54B56", "#93C54B")) + labs(title = "Enjoyability compared to Familiarity with language and valence",x="Average Familiarity of the Song", y="Average Enjoyability of the Song")
```
