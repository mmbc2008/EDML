...
server <- function(input, output) {
    runjs("document.getElementById('myaudio').volume = 0.2;") # initially reduce volume
        runjs(sprintf("document.getElementById('myaudio').src = '%s';", "https://p.scdn.co/mp3-preview/9d68ec32f79cd83e01ef61e70b780989b577b7f4?cid=e1672700ae5648848338d2352cdc375e"))
}
...
---------------------------------------------------
### Selection process
Explanation of how songs were selected

Column
--------------------------------------------------
### Song data
Table with the songs, artists, languages and valences (according to Spotify)
